...
__host__ __device__ __forceinline__ void sphereOnSphere(const size_t i, const int j, const SphereDevice sd, Vec3& fi, Vec3& ti)
{
...
__host__ __device__ __forceinline__ void sphereOnPlane(const size_t i, const int j, const SphereDevice sd, const PlaneDevice pd, Vec3& fi, Vec3& ti)
{
