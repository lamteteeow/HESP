...
struct Vec3
{
    ...
    __host__ __device__ __forceinline__ bool operator==(const Vec3& v) const noexcept
    {
        return this->x == v.x &&
        this->y == v.y &&
        this->z == v.z;
    ...
    __host__ __device__ __forceinline__ Vec3& operator+=(const Vec3& rhs) noexcept
    {
        this->x += rhs.x;
        this->y += rhs.y;
        this->z += rhs.z;
    ...
    __host__ __device__ __forceinline__ friend Vec3 operator*(const float lhs, const Vec3& rhs) noexcept
    {
        return rhs * lhs;
    }
...
__host__ __device__ __forceinline__ float dot(const Vec3& lhs, const Vec3& rhs)
{
    return lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z;
}

__host__ __device__ __forceinline__ Vec3 cross(const Vec3& lhs, const Vec3& rhs)
{
