...
#   HALO=cpu sbatch.tinygpu --gres=gpu:a100:4 scripts/bench.sh crossing_freq 50000 4
#   MIGRATE=gpu sbatch.tinygpu --gres=gpu:rtx3080:4 --partition=rtx3080 scripts/bench.sh crossing_freq 50000 4
#
# Examples:
#   # 1-GPU baseline
...
#   MIGRATE=gpu sbatch.tinygpu --gres=gpu:a100:4 --partition=a100 scripts/bench.sh crossing_freq 50000 4 100000 0
#
#   # 4-GPU RTX 3080, CPU halo baseline
#   HALO=cpu sbatch.tinygpu --gres=gpu:rtx3080:4 --partition=rtx3080 scripts/bench.sh crossing_freq 50000 4 100000 0
# ============================================================================
